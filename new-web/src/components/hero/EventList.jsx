...
// I want the width and height of both component to be consistent and not take more than 70% of the screen width. the images height and width must also be the same regardless of the original height and width of the image.